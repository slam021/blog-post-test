    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card border-0 shadow-sm rounded">
                <div class="card-body">
                    <h4 class="my-4 mt-2">Tambah Post</h4>
                    <hr>
                    <form action="{{ route('post.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="date" class="form-control @error('date_post') is-invalid @enderror" name="date_post" id="date_post" value="{{ old('date_post') }}" placeholder="Masukkan Tanggal..." autocomplete="off">
                            @error('date_post')
                                <div class="alert alert-danger mt-2">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control @error('content') is-invalid @enderror" name="content" rows="5" placeholder="Masukkan Konten..." autocomplete="off">{{ old('content') }}</textarea>
                            @error('content')
                                <div class="alert alert-danger mt-2">
                                    {{ $message }}
                                </div>
